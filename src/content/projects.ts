...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    title: "QLU.ai",
    description:
      "QLU is designed for executive search teams. We help researchers, heads of research, partners, and principals build market maps, find similar companies, and discover the best candidates in just a few minutes.",
    image: "https://placehold.co/800x450/6366f1/ffffff?text=Qlu.ai",
    tags: [
